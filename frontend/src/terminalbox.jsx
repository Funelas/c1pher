    ...
    <div className="terminal-box">
      <div className="terminal-title flex justify-between items-center">
        ...
        <div className="flex">
          ...
          >
            <circle cx="14.86" cy="9.14" r="7.64" stroke="currentColor" fill="none" strokeWidth="1.91" />
            <line x1="1.5" y1="22.5" x2="9.61" y2="14.39" stroke="currentColor" strokeWidth="1.91" />
            <rect x="12.95" y="6.27" width="3.82" height="6.68" rx="1.91" stroke="currentColor" fill="none" strokeWidth="1.91" />
            <line x1="11.05" y1="8.18" x2="12.95" y2="8.18" stroke="currentColor" strokeWidth="1.91" />
            <line x1="18.68" y1="8.18" x2="16.77" y2="8.18" stroke="currentColor" strokeWidth="1.91" />
            <line x1="11.05" y1="12" x2="12.95" y2="12" stroke="currentColor" strokeWidth="1.91" />
            <line x1="18.68" y1="12" x2="16.77" y2="12" stroke="currentColor" strokeWidth="1.91" />
            <line x1="12.95" y1="4.36" x2="13.91" y2="6.27" stroke="currentColor" strokeWidth="1.91" />
            <line x1="16.77" y1="4.36" x2="15.82" y2="6.27" stroke="currentColor" strokeWidth="1.91" />
          </svg>
